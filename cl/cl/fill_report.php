...
<?php
    ...
    else
    {
        ...
        $report = $_POST['report'];
        $fees = $_POST['fees'];
        $sql = "INSERT INTO report(appointmentid,doctorid,patientid,report_full,fees) values('$appointmentid','$doctorid','$patientid','$report','$fees')";
...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Report Record Inserted Successfully</p>
                <p>
                 <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                 <?php echo "<script>setTimeout(\"location.href = 'fill_report.php';\",1500);</script>"; ?>
                </p>
              </div>
            </div>
<?php
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="p_name" id="p_name" placeholder="Enter name...." required=""   >
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <textarea name="report" rows="10" cols="45" placeholder="Enter report"></textarea>
            <span class="messages"></span>
        </div>
    </div>

    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Consultancy Fees</label>
        <div class="col-sm-4">
